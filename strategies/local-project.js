...
var localProject = /** @class */ (function () {
    function localProject() {
        ...
        this.loadData = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, util.promisify(fs.readFile)("data.txt")];
                    case 1:
                        data = _a.sent();
        ...
        this.persistData = function (key, data) {
            fs.writeFile("data.txt", JSON.stringify(data), function (error) {
                if (error) {
...
//# sourceMappingURL=local-project.js.map